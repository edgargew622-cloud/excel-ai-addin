    ...
    parameters: {
      ...
      properties: {
        ...
        columnWidth: {
          ...
          minimum: 0,
          maximum: 1600,
          description: "Ширина каждого столбца области в пунктах (не в символах): примерно 7 пунктов на символ шрифта по умолчанию. Excel подгоняет её к сетке экрана."
        },
