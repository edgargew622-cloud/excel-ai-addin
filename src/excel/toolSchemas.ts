...
export const TOOL_SPECS: ToolSpec[] = [
  ...
  },
  {
    ...
    description:
      ...
      "новый заменит уже стоящий вместе с его условиями, и предпросмотр об этом предупредит. Области внутри таблиц Excel отклоняются — у таблицы свой фильтр.",
    parameters: {
      type: "object",
      properties: {
        sheet: sheetProp,
...
- Фильтр заменяет уже стоящий на листе вместе с его условиями: если в предпросмотре есть прежний фильтр, скажи об этом. В отчёте называй visibleRowsBefore и visibleRowsAfter из ответа.
